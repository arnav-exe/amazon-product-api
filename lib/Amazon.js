...
class AmazonScraper {
    ...
    async startScraper() {
        ...
        if (this.cli && this.fileType !== 'none') {
            spinner.start();
        }
        ...
        if (this.fileType && this.fileType !== 'none' && this.cli) {
    ...
    grabAsinDetails(body) {
        ...
        try {
            ...
            output.price.current_price = 0;
        }
        if (!output.price.current_price || output.price.current_price === 0) {
            try {
